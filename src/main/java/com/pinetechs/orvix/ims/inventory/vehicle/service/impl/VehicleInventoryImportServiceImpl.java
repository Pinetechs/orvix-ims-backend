...
public class VehicleInventoryImportServiceImpl implements VehicleInventoryImportService {
    ...
    public UploadExcelResponse uploadExcel(Long taskId, MultipartFile file, User currentUser) {
        ...
        if (task.getStatus() != InventoryTaskStatus.CREATED && task.getStatus() != InventoryTaskStatus.IMPORT_FAILED && task.getStatus() != InventoryTaskStatus.DRAFT && task.getStatus() != InventoryTaskStatus.IMPORT_COMPLETED) {
