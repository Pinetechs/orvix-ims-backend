...
@Entity
@Table(
        name = "asset_inventory_places",
        indexes = {
                @Index(name = "idx_asset_inv_places_task", columnList = "task_id"),
                @Index(name = "idx_asset_inv_places_location", columnList = "location_id"),
                @Index(name = "idx_asset_inv_places_floor", columnList = "floor_id"),
                @Index(name = "idx_asset_inv_places_name", columnList = "place_name")
        },
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_asset_inv_place_task_location_floor_name",
                        columnNames = {"task_id", "location_id", "floor_id", "place_name"}
                )
        }
)
public class AssetInventoryPlace {
    ...
    private AssetInventoryFloor floor;
    ...
    public AssetInventoryFloor getFloor() { return floor; }
    public void setFloor(AssetInventoryFloor floor) { this.floor = floor; }
